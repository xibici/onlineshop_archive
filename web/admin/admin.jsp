...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			...
			<li>
					<a class="glyphicon glyphicon-off" href="${pageContext.request.contextPath}/adminServlet?method=logOut" onclick="return confirm('确定要退出吗?')">注销</a>
			</li>
		</ul>
		<!--左侧边栏 -->
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminServlet?method=getGoodsTypeList");
				})
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminServlet?method=getGoodsList");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/addGoods.jsp"); //admin.jsp进去
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminServlet?method=getAllOrder");
				})
			</script>
